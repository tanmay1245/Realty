...
const CreateListing = () => {
    ...
    const createListingHandler = () => {
        if (requiredFieldsValidation()) {
            ...
            setLoading(true);
            axios.post("/api/listing/create", formData).then((response) => {
    ...
    return (
        <div className="font-poppins w-full flex justify-center pt-12 h-screen dark:bg-[#212121]">
            <div className="w-full sm:w-[600px] md:w-[720px] lg:w-[840px] flex flex-col items-center">
                <div>
                    <span className="text-[#344564] font-bold text-2xl dark:text-white">Create a Listing</span>
                </div>
